...
export async function httpProbe(url, timeout = 2000) {
...
export async function tcpProbe(host, port, timeout = 2000) {
    return new Promise((resolve) => {
...
export async function waitForService(urlOrHost, port, timeout = 5000) {
