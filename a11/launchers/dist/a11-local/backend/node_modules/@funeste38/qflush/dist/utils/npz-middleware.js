...
export function npzMiddleware(opts = {}) {
    ...
    return async function (req, res, next) {
        ...
        try {
            // assign npz_id
            const npz_id = req.headers['x-npz-id'] || req.cookies?.['npz_id'] || uuidv4();
            ...
            const report = await npzRoute({ method: req.method, url: fullUrl, headers: req.headers, body: req.body });
