...
export function checksumBufferIgnoringRomeTag(buf) {
...
export function checksumFileIgnoringRomeTag(filePath) {
    const raw = fs.readFileSync(filePath);
    return checksumBufferIgnoringRomeTag(raw);
}
// Flexible checksum: try multiple decoding strategies
export async function flexibleChecksumBuffer(buf) {
...
export async function flexibleChecksumFile(filePath) {
    const raw = fs.readFileSync(filePath);
