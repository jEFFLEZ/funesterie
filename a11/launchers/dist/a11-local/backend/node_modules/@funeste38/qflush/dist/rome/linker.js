...
export function computeRomeLinks(projectRoot) {
...
export function computeRomeLinksForFiles(projectRoot, absFiles) {
...
export function readExistingLinks(projectRoot) {
...
export function mergeAndWrite(projectRoot, newLinks) {
